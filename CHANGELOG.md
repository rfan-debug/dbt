...
- Requirement on `dataclasses` is relaxed to be between `>=0.6,<0.9` allowing dbt to cohabit with other libraries which required higher versions. ([#3150](https://github.com/dbt-labs/dbt/issues/3150), [#3151](https://github.com/dbt-labs/dbt/pull/3151))
...
- [@monti-python](https://github.com/monti-python) ([#3247](https://github.com/dbt-labs/dbt/issues/3247))
...
- Fix regression with defining exposures and other resources with the same name ([#2969](https://github.com/dbt-labs/dbt/issues/2969), [#3009](https://github.com/dbt-labs/dbt/pull/3009))
...
- `dbt compile` and `dbt run` failed with `KeyError: 'endpoint_resolver'` when threads > 1 and `method: iam` had been specified in the profiles.yaml ([#2756](https://github.com/dbt-labs/dbt/issues/2756), [#2766](https://github.com/dbt-labs/dbt/pull/2766))
...
- Added 3 more adapter methods that the new dbt-adapter-test suite can use for testing. ([#2492](https://github.com/dbt-labs/dbt/issues/2492), [#2721](https://github.com/dbt-labs/dbt/pull/2721))
...
- Macros in the current project can override internal dbt macros that are called through `execute_macros`. ([#2301](https://github.com/dbt-labs/dbt/issues/2301), [#2686](https://github.com/dbt-labs/dbt/pull/2686))
...
- Added option "--adapter" to `dbt init` to create a sample `profiles.yml` based on the chosen adapter ([#2533](https://github.com/dbt-labs/dbt/issues/2533), [#2594](https://github.com/dbt-labs/dbt/pull/2594))
...
- Parallel RPC requests no longer step on each others' arguments ([[#2484](https://github.com/dbt-labs/dbt/issues/2484), [#2554](https://github.com/dbt-labs/dbt/pull/2554)])
...
- Fixed a number of issues with globally-scoped vars ([#2473](https://github.com/dbt-labs/dbt/issues/2473), [#2472](https://github.com/dbt-labs/dbt/issues/2472), [#2469](https://github.com/dbt-labs/dbt/issues/2469), [#2477](https://github.com/dbt-labs/dbt/pull/2477))
...
- Added a '--no-browser' argument to "dbt docs serve" so you can serve docs in an environment that only has a CLI browser which would otherwise deadlock dbt ([#2004](https://github.com/dbt-labs/dbt/issues/2004), [#2364](https://github.com/dbt-labs/dbt/pull/2364))
- Snowflake now uses "describe table" to get the columns in a relation ([#2260](https://github.com/dbt-labs/dbt/issues/2260), [#2324](https://github.com/dbt-labs/dbt/pull/2324))
...
- The ambiguous alias check now examines the node's database value as well as the schema/identifier ([#2326](https://github.com/dbt-labs/dbt/issues/2326), [#2387](https://github.com/dbt-labs/dbt/pull/2387))
...
- Macro name collisions between dbt and plugins now raise an appropriate exception, instead of an AttributeError ([#2288](https://github.com/dbt-labs/dbt/issues/2288), [#2293](https://github.com/dbt-labs/dbt/pull/2293))
...
- When overriding the snowflake\_\_list_schemas macro, you must now run a result with a column named 'name' instead of the first column ([#2171](https://github.com/dbt-labs/dbt/pull/2171))
...
- Add a "docs" field to models, with a "show" subfield ([#1671](https://github.com/dbt-labs/dbt/issues/1671), [#2107](https://github.com/dbt-labs/dbt/pull/2107))
- Add an optional "sslmode" parameter for postgres ([#2152](https://github.com/dbt-labs/dbt/issues/2152), [#2154](https://github.com/dbt-labs/dbt/pull/2154))
- Remove the requirement to have a passphrase when using Snowflake key pair authentication ([#1804](https://github.com/dbt-labs/dbt/issues/1805), [#2164](https://github.com/dbt-labs/dbt/pull/2164))
- Support a cost-effective approach for incremental models on BigQuery using scription ([#1034](https://github.com/dbt-labs/dbt/issues/1034), [#2140](https://github.com/dbt-labs/dbt/pull/2140))
- Add a dbt-{dbt_version} user agent field to the bigquery connector ([#2121](https://github.com/dbt-labs/dbt/issues/2121), [#2146](https://github.com/dbt-labs/dbt/pull/2146))
- Add support for `generate_database_name` macro ([#1695](https://github.com/dbt-labs/dbt/issues/1695), [#2143](https://github.com/dbt-labs/dbt/pull/2143))
- Expand the search path for schema.yml (and by extension, the default docs path) to include macro-paths and analysis-paths (in addition to source-paths, data-paths, and snapshot-paths) ([#2155](https://github.com/dbt-labs/dbt/issues/2155), [#2160](https://github.com/dbt-labs/dbt/pull/2160))

### Fixes

- Fix issue where dbt did not give an error in the presence of duplicate doc names ([#2054](https://github.com/dbt-labs/dbt/issues/2054), [#2080](https://github.com/dbt-labs/dbt/pull/2080))
- Include vars provided to the cli method when running the actual method ([#2092](https://github.com/dbt-labs/dbt/issues/2092), [#2104](https://github.com/dbt-labs/dbt/pull/2104))
- Improved error messages with malformed packages.yml ([#2017](https://github.com/dbt-labs/dbt/issues/2017), [#2078](https://github.com/dbt-labs/dbt/pull/2078))
- Fix an issue where dbt rendered source test args, fix issue where dbt ran an extra compile pass over the wrapped SQL. ([#2114](https://github.com/dbt-labs/dbt/issues/2114), [#2150](https://github.com/dbt-labs/dbt/pull/2150))
- Set more upper bounds for jinja2,requests, and idna dependencies, upgrade snowflake-connector-python ([#2147](https://github.com/dbt-labs/dbt/issues/2147), [#2151](https://github.com/dbt-labs/dbt/pull/2151))

Contributors:

- [@bubbomb](https://github.com/bubbomb) ([#2080](https://github.com/dbt-labs/dbt/pull/2080))
- [@sonac](https://github.com/sonac) ([#2078](https://github.com/dbt-labs/dbt/pull/2078))

## dbt 0.16.0b1 (February 11, 2020)

### Breaking changes

- Update the debug log format ([#2099](https://github.com/dbt-labs/dbt/pull/2099))
- Removed `docrefs` from output ([#2096](https://github.com/dbt-labs/dbt/pull/2096))
- Contexts updated to be more consistent and well-defined ([#1053](https://github.com/dbt-labs/dbt/issues/1053), [#1981](https://github.com/dbt-labs/dbt/issues/1981), [#1255](https://github.com/dbt-labs/dbt/issues/1255), [#2085](https://github.com/dbt-labs/dbt/pull/2085))
- The syntax of the `get_catalog` macro has changed ([#2037](https://github.com/dbt-labs/dbt/pull/2037))
- Agate type inference is no longer locale-specific. Only a small number of date/datetime formats are supported. If a seed has a specified column type, agate will not perform any type inference (it will instead be cast from a string). ([#999](https://github.com/dbt-labs/dbt/issues/999), [#1639](https://github.com/dbt-labs/dbt/issues/1639), [#1920](https://github.com/dbt-labs/dbt/pull/1920))

### Features

- Add column-level quoting control for tests ([#2106](https://github.com/dbt-labs/dbt/issues/2106), [#2047](https://github.com/dbt-labs/dbt/pull/2047))
- Add the macros every node uses to its `depends_on.macros` list ([#2082](https://github.com/dbt-labs/dbt/issues/2082), [#2103](https://github.com/dbt-labs/dbt/pull/2103))
- Add `arguments` field to macros ([#2081](https://github.com/dbt-labs/dbt/issues/2081), [#2083](https://github.com/dbt-labs/dbt/issues/2083), [#2096](https://github.com/dbt-labs/dbt/pull/2096))
- Batch the anonymous usage statistics requests to improve performance ([#2008](https://github.com/dbt-labs/dbt/issues/2008), [#2089](https://github.com/dbt-labs/dbt/pull/2089))
- Add documentation for macros/analyses ([#1041](https://github.com/dbt-labs/dbt/issues/1041), [#2068](https://github.com/dbt-labs/dbt/pull/2068))
- Search for docs in 'data' and 'snapshots' folders, in addition to 'models' ([#1832](https://github.com/dbt-labs/dbt/issues/1832), [#2058](https://github.com/dbt-labs/dbt/pull/2058))
- Add documentation for snapshots and seeds ([#1974](https://github.com/dbt-labs/dbt/issues/1974), [#2051](https://github.com/dbt-labs/dbt/pull/2051))
- Add `Column.is_number`/`Column.is_float` methods ([#1969](https://github.com/dbt-labs/dbt/issues/1969), [#2046](https://github.com/dbt-labs/dbt/pull/2046))
- Detect duplicate macros and cause an error when they are detected ([#1891](https://github.com/dbt-labs/dbt/issues/1891), [#2045](https://github.com/dbt-labs/dbt/pull/2045))
- Add support for `--select` on `dbt seed` ([#1711](https://github.com/dbt-labs/dbt/issues/1711), [#2042](https://github.com/dbt-labs/dbt/pull/2042))
- Add tags for sources (like model tags) and columns (tags apply to tests of that column) ([#1906](https://github.com/dbt-labs/dbt/issues/1906), [#1586](https://github.com/dbt-labs/dbt/issues/1586), [#2039](https://github.com/dbt-labs/dbt/pull/2039))
- Improve the speed of catalog generation by performing multiple smaller queries instead of one huge query ([#2009](https://github.com/dbt-labs/dbt/issues/2009), [#2037](https://github.com/dbt-labs/dbt/pull/2037))
- Add`toyaml` and `fromyaml` methods to the base context ([#1911](https://github.com/dbt-labs/dbt/issues/1911), [#2036](https://github.com/dbt-labs/dbt/pull/2036))
- Add `database_schemas` to the on-run-end context ([#1924](https://github.com/dbt-labs/dbt/issues/1924), [#2031](https://github.com/dbt-labs/dbt/pull/2031))
- Add the concept of `builtins` to the dbt context, make it possible to override functions like `ref` ([#1603](https://github.com/dbt-labs/dbt/issues/1603), [#2028](https://github.com/dbt-labs/dbt/pull/2028))
- Add a `meta` key to most `schema.yml` objects ([#1362](https://github.com/dbt-labs/dbt/issues/1362), [#2015](https://github.com/dbt-labs/dbt/pull/2015))
- Add clickable docs URL link in CLI output ([#2027](https://github.com/dbt-labs/dbt/issues/2027), [#2131](https://github.com/dbt-labs/dbt/pull/2131))
- Add `role` parameter in Postgres target configuration ([#1955](https://github.com/dbt-labs/dbt/issues/1955), [#2137](https://github.com/dbt-labs/dbt/pull/2137))
- Parse model hooks and collect `ref` statements ([#1957](https://github.com/dbt-labs/dbt/issues/1957), [#2025](https://github.com/dbt-labs/dbt/pull/2025))

### Fixes

- Fix the help output for `dbt docs` and `dbt source` to not include misleading flags ([#2038](https://github.com/dbt-labs/dbt/issues/2038), [#2105](https://github.com/dbt-labs/dbt/pull/2105))
- Allow `dbt debug` from subdirectories ([#2086](https://github.com/dbt-labs/dbt/issues/2086), [#2094](https://github.com/dbt-labs/dbt/pull/2094))
- Fix the `--no-compile` flag to `dbt docs generate` not crash dbt ([#2090](https://github.com/dbt-labs/dbt/issues/2090), [#2093](https://github.com/dbt-labs/dbt/pull/2093))
- Fix issue running `dbt debug` with an empty `dbt_project.yml` file ([#2116](https://github.com/dbt-labs/dbt/issues/2116), [#2120](https://github.com/dbt-labs/dbt/pull/2120))
- Ovewrwrite source config fields that should clobber, rather than deep merging them ([#2049](https://github.com/dbt-labs/dbt/issues/2049), [#2062](https://github.com/dbt-labs/dbt/pull/2062))
- Fix a bug in macro search where built-in macros could not be overridden for `dbt run-operation` ([#2032](https://github.com/dbt-labs/dbt/issues/2032), [#2035](https://github.com/dbt-labs/dbt/pull/2035))
- dbt now detects dependencies with the same name as the current project as an error instead of silently clobbering each other ([#2029](https://github.com/dbt-labs/dbt/issues/2029), [#2030](https://github.com/dbt-labs/dbt/pull/2030))
- Exclude tests of disabled models in compile statistics ([#1804](https://github.com/dbt-labs/dbt/issues/1804), [#2026](https://github.com/dbt-labs/dbt/pull/2026))
- Do not show ephemeral models as being cancelled during ctrl+c ([#1993](https://github.com/dbt-labs/dbt/issues/1993), [#2024](https://github.com/dbt-labs/dbt/pull/2024))
- Improve errors on plugin import failure ([#2006](https://github.com/dbt-labs/dbt/issues/2006), [#2022](https://github.com/dbt-labs/dbt/pull/2022))
- Fix the behavior of the `project-dir` argument when running `dbt debug` ([#1733](https://github.com/dbt-labs/dbt/issues/1733), [#1989](https://github.com/dbt-labs/dbt/pull/1989))

### Under the hood

- Improve the CI process for externally-contributed PRs ([#2033](https://github.com/dbt-labs/dbt/issues/2033), [#2097](https://github.com/dbt-labs/dbt/pull/2097))
- lots and lots of mypy/typing fixes ([#2010](https://github.com/dbt-labs/dbt/pull/2010))

Contributors:

- [@aaronsteers](https://github.com/aaronsteers) ([#2131](https://github.com/dbt-labs/dbt/pull/2131))
- [@alanmcruickshank](https://github.com/alanmcruickshank) ([#2028](https://github.com/dbt-labs/dbt/pull/2028))
- [@franloza](https://github.com/franloza) ([#1989](https://github.com/dbt-labs/dbt/pull/1989))
- [@heisencoder](https://github.com/heisencoder) ([#2099](https://github.com/dbt-labs/dbt/pull/2099))
- [@nchammas](https://github.com/nchammas) ([#2120](https://github.com/dbt-labs/dbt/pull/2120))
- [@NiallRees](https://github.com/NiallRees) ([#2026](https://github.com/dbt-labs/dbt/pull/2026))
- [@shooka](https://github.com/shooka) ([#2137](https://github.com/dbt-labs/dbt/pull/2137))
- [@tayloramurphy](https://github.com/tayloramurphy) ([#2015](https://github.com/dbt-labs/dbt/pull/2015))
...
- Use refresh tokens in snowflake instead of access tokens ([#2126](https://github.com/dbt-labs/dbt/issues/2126), [#2141](https://github.com/dbt-labs/dbt/pull/2141))
...
- Add support for Snowflake OAuth authentication ([#2050](https://github.com/dbt-labs/dbt/issues/2050), [#2069](https://github.com/dbt-labs/dbt/pull/2069))
- Add a -t flag as an alias for `dbt run --target` ([#1281](https://github.com/dbt-labs/dbt/issues/1281), [#2057](https://github.com/dbt-labs/dbt/pull/2057))

### Fixes

- Fix for UnicodeDecodeError when installing dbt via pip ([#1771](https://github.com/dbt-labs/dbt/issues/1771), [#2076](https://github.com/dbt-labs/dbt/pull/2076))
- Fix for ability to clean "protected" paths in the `dbt clean` command and improve logging ([#2059](https://github.com/dbt-labs/dbt/issues/2059), [#2060](https://github.com/dbt-labs/dbt/pull/2060))
- Fix for dbt server error when `{% docs %}` tags are malformed ([#2066](https://github.com/dbt-labs/dbt/issues/2066), [#2067](https://github.com/dbt-labs/dbt/pull/2067))
- Fix for errant duplicate resource errors when models are disabled and partial parsing is enabled ([#2055](https://github.com/dbt-labs/dbt/issues/2055), [#2056](https://github.com/dbt-labs/dbt/pull/2056))
- Fix for errant duplicate resource errors when a resource is included in multiple source paths ([#2064](https://github.com/dbt-labs/dbt/issues/2064), [#2065](https://github.com/dbt-labs/dbt/pull/2065/files))

Contributors:

- [@markberger](https://github.com/markeberger) ([#2076](https://github.com/dbt-labs/dbt/pull/2076))
- [@emilieschario](https://github.com/emilieschario) ([#2060](https://github.com/dbt-labs/dbt/pull/2060))
...
- Lazily load database connections ([#1584](https://github.com/dbt-labs/dbt/issues/1584), [#1992](https://github.com/dbt-labs/dbt/pull/1992))
- Support raising warnings in user-space ([#1970](https://github.com/dbt-labs/dbt/issues/1970), [#1977](https://github.com/dbt-labs/dbt/pull/1977))
- Suppport BigQuery label configuration for models ([#1942](https://github.com/dbt-labs/dbt/issues/1942), [#1964](https://github.com/dbt-labs/dbt/pull/1964))
- Support retrying when BigQuery models fail with server errors ([#1579](https://github.com/dbt-labs/dbt/issues/1579), [#1963](https://github.com/dbt-labs/dbt/pull/1963))
- Support sql headers in create table/view statements ([#1879](https://github.com/dbt-labs/dbt/issues/1879), [#1967](https://github.com/dbt-labs/dbt/pull/1967))
- Add source snapshot-freshness to dbt rpc ([#2040](https://github.com/dbt-labs/dbt/issues/2040), [#2041](https://github.com/dbt-labs/dbt/pull/2041))

### Fixes

- Fix for catalog generation error when datasets are missing on BigQuery ([#1984](https://github.com/dbt-labs/dbt/issues/1984), [#2005](https://github.com/dbt-labs/dbt/pull/2005))
- Fix for invalid SQL generated when "check" strategy is used in Snapshots with changing schemas ([#1797](https://github.com/dbt-labs/dbt/issues/1797), [#2001](https://github.com/dbt-labs/dbt/pull/2001)(
- Fix for gaps in valid_from and valid_to timestamps when "check" strategy is used in Snapshots on some databases ([#1736](https://github.com/dbt-labs/dbt/issues/1736), [#1994](https://github.com/dbt-labs/dbt/pull/1994))
- Fix incorrect thread names in dbt server logs ([#1905](https://github.com/dbt-labs/dbt/issues/1905), [#2002](https://github.com/dbt-labs/dbt/pull/2002))
- Fix for ignored catalog data when user schemas begin with `pg*` on Postgres and Redshift ([#1960](https://github.com/dbt-labs/dbt/issues/1960), [#2003](https://github.com/dbt-labs/dbt/pull/2003))
- Fix for poorly defined materialization resolution logic ([#1962](https://github.com/dbt-labs/dbt/issues/1962), [#1976](https://github.com/dbt-labs/dbt/pull/1976))
- Fix missing `drop_schema` method in adapter namespace ([#1980](https://github.com/dbt-labs/dbt/issues/1980), [#1983](https://github.com/dbt-labs/dbt/pull/1983))
- Fix incorrect `generated_at` value in the catalog ([#1988](https://github.com/dbt-labs/dbt/pull/1988))

### Under the hood

- Fail more gracefully at install time when setuptools is downlevel ([#1975](https://github.com/dbt-labs/dbt/issues/1975), [#1978](https://github.com/dbt-labs/dbt/pull/1978))
- Make the `DBT_TEST_ALT` integration test warehouse configurable on Snowflake ([#1939](https://github.com/dbt-labs/dbt/issues/1939), [#1979](https://github.com/dbt-labs/dbt/pull/1979))
- Pin upper bound on `google-cloud-bigquery` dependency to `1.24.0`. ([#2007](https://github.com/dbt-labs/dbt/pull/2007))
- Remove duplicate `get_context_modules` method ([#1996](https://github.com/dbt-labs/dbt/pull/1996))
- Add type annotations to base adapter code ([#1982](https://github.com/dbt-labs/dbt/pull/1982))

Contributors:

- [@Fokko](https://github.com/Fokko) ([#1996](https://github.com/dbt-labs/dbt/pull/1996), [#1988](https://github.com/dbt-labs/dbt/pull/1988), [#1982](https://github.com/dbt-labs/dbt/pull/1982))
- [@kconvey](https://github.com/kconvey) ([#1967](https://github.com/dbt-labs/dbt/pull/1967))
...
- Compilation errors in .yml files are now treated as errors instead of warnings ([#1493](https://github.com/dbt-labs/dbt/issues/1493), [#1751](https://github.com/dbt-labs/dbt/pull/1751))
- The 'table_name' field field has been removed from Relations
- The existing `compile` and `execute` rpc tasks have been renamed to `compile_sql` and `execute_sql` ([#1779](https://github.com/dbt-labs/dbt/issues/1779), [#1798](https://github.com/dbt-labs/dbt/pull/1798)) ([docs](https://docs.getdbt.com/v0.15/docs/rpc))
...
- Add a JSON logger ([#1237](https://github.com/dbt-labs/dbt/issues/1237), [#1791](https://github.com/dbt-labs/dbt/pull/1791)) ([docs](https://docs.getdbt.com/v0.15/docs/global-cli-flags#section-log-formatting))
- Add structured logging to dbt ([#1704](https://github.com/dbt-labs/dbt/issues/1704), [#1799](https://github.com/dbt-labs/dbt/issues/1799), [#1715](https://github.com/dbt-labs/dbt/pull/1715), [#1806](https://github.com/dbt-labs/dbt/pull/1806))
- Add partial parsing option to the profiles.yml file ([#1835](https://github.com/dbt-labs/dbt/issues/1835), [#1836](https://github.com/dbt-labs/dbt/pull/1836), [#1487](https://github.com/dbt-labs/dbt/issues/1487)) ([docs](https://docs.getdbt.com/v0.15/docs/configure-your-profile#section-partial-parsing))
- Support configurable query comments in SQL queries ([#1643](https://github.com/dbt-labs/dbt/issues/1643), [#1864](https://github.com/dbt-labs/dbt/pull/1864)) ([docs](https://docs.getdbt.com/v0.15/docs/configuring-query-comments))
- Support atomic full-refreshes for incremental models ([#525](https://github.com/dbt-labs/dbt/issues/525), [#1682](https://github.com/dbt-labs/dbt/pull/1682))
- Support snapshot configs in dbt_project.yml ([#1613](https://github.com/dbt-labs/dbt/issues/1613), [#1759](https://github.com/dbt-labs/dbt/pull/1759)) ([docs](https://docs.getdbt.com/v0.15/docs/snapshots#section-configuring-snapshots-in-dbt_project-yml))
- Support cache modifications in materializations ([#1683](https://github.com/dbt-labs/dbt/issues/1683), [#1770](https://github.com/dbt-labs/dbt/pull/1770)) ([docs](https://docs.getdbt.com/v0.15/docs/creating-new-materializations#section-6-update-the-relation-cache))
- Support `quote` parameter to Accepted Values schema tests ([#1873](https://github.com/dbt-labs/dbt/issues/1873), [#1876](https://github.com/dbt-labs/dbt/pull/1876)) ([docs](https://docs.getdbt.com/v0.15/docs/testing#section-accepted-values))
- Support Python 3.8 ([#1886](https://github.com/dbt-labs/dbt/pull/1886))
- Support filters in sources for `dbt source snapshot-freshness` invocation ([#1495](https://github.com/dbt-labs/dbt/issues/1495), [#1776](https://github.com/dbt-labs/dbt/pull/1776)) ([docs](https://docs.getdbt.com/v0.15/docs/using-sources#section-filtering-sources))
- Support external table configuration in yml source specifications ([#1784](https://github.com/dbt-labs/dbt/pull/1784))
- Improve CLI output when running snapshots ([#1768](https://github.com/dbt-labs/dbt/issues/1768), [#1769](https://github.com/dbt-labs/dbt/pull/1769))

#### Fixes

- Fix for unhelpful error message for malformed source/ref inputs ([#1660](https://github.com/dbt-labs/dbt/issues/1660), [#1809](https://github.com/dbt-labs/dbt/pull/1809))
- Fix for lingering backup tables when incremental models are full-refreshed ([#1933](https://github.com/dbt-labs/dbt/issues/1933), [#1931](https://github.com/dbt-labs/dbt/pull/1931))
- Fix for confusing error message when errors are encountered during compilation ([#1807](https://github.com/dbt-labs/dbt/issues/1807), [#1839](https://github.com/dbt-labs/dbt/pull/1839))
- Fix for logic error affecting the two-argument flavor of the `ref` function ([#1504](https://github.com/dbt-labs/dbt/issues/1504), [#1515](https://github.com/dbt-labs/dbt/pull/1515))
- Fix for invalid reference to dbt.exceptions ([#1569](https://github.com/dbt-labs/dbt/issues/1569), [#1609](https://github.com/dbt-labs/dbt/pull/1609))
- Fix for "cannot run empty query" error when pre/post-hooks are empty ([#1108](https://github.com/dbt-labs/dbt/issues/1108), [#1719](https://github.com/dbt-labs/dbt/pull/1719))
- Fix for confusing error when project names shadow context attributes ([#1696](https://github.com/dbt-labs/dbt/issues/1696), [#1748](https://github.com/dbt-labs/dbt/pull/1748))
- Fix for incorrect database logic in docs generation which resulted in columns being "merged" together across tables ([#1708](https://github.com/dbt-labs/dbt/issues/1708), [#1774](https://github.com/dbt-labs/dbt/pull/1774))
- Fix for seed errors located in dependency packages ([#1723](https://github.com/dbt-labs/dbt/issues/1723), [#1723](https://github.com/dbt-labs/dbt/issues/1723))
- Fix for confusing error when schema tests return unexpected results ([#1808](https://github.com/dbt-labs/dbt/issues/1808), [#1903](https://github.com/dbt-labs/dbt/pull/1903))
- Fix for twice-compiled `statement` block contents ([#1717](https://github.com/dbt-labs/dbt/issues/1717), [#1719](https://github.com/dbt-labs/dbt/pull/1719))
- Fix for inaccurate output in `dbt run-operation --help` ([#1767](https://github.com/dbt-labs/dbt/issues/1767), [#1777](https://github.com/dbt-labs/dbt/pull/1777))
- Fix for file rotation issues concerning the `logs/dbt.log` file ([#1863](https://github.com/dbt-labs/dbt/issues/1863), [#1865](https://github.com/dbt-labs/dbt/issues/1865), [#1871](https://github.com/dbt-labs/dbt/pull/1871))
- Fix for missing quotes in incremental model build queries ([#1847](https://github.com/dbt-labs/dbt/issues/1847), [#1888](https://github.com/dbt-labs/dbt/pull/1888))
- Fix for incorrect log level in `printer.print_run_result_error` ([#1818](https://github.com/dbt-labs/dbt/issues/1818), [#1823](https://github.com/dbt-labs/dbt/pull/1823))
...
- Support docs generation ([#1781](https://github.com/dbt-labs/dbt/issues/1781), [#1801](https://github.com/dbt-labs/dbt/pull/1801))
- Support custom tags ([#1822](https://github.com/dbt-labs/dbt/issues/1822), [#1828](https://github.com/dbt-labs/dbt/pull/1828))
- Support invoking `deps` on the rpc server ([#1834](https://github.com/dbt-labs/dbt/issues/1834), [#1837](https://github.com/dbt-labs/dbt/pull/1837))
- Support invoking `run-operation` and `snapshot` on the rpc server ([#1875](https://github.com/dbt-labs/dbt/issues/1875), [#1878](https://github.com/dbt-labs/dbt/pull/1878))
- Suppport `--threads` argument to `cli_args` method ([#1897](https://github.com/dbt-labs/dbt/issues/1897), [#1909](https://github.com/dbt-labs/dbt/pull/1909))
- Support reloading the manifest when a SIGHUP signal is received ([#1684](https://github.com/dbt-labs/dbt/issues/1684), [#1699](https://github.com/dbt-labs/dbt/pull/1699))
- Support invoking `compile`, `run`, `test`, and `seed` on the rpc server ([#1488](https://github.com/dbt-labs/dbt/issues/1488), [#1652](https://github.com/dbt-labs/dbt/pull/1652))
- Support returning compilation logs from the last compile in the `status` method ([#1703](https://github.com/dbt-labs/dbt/issues/1703), [#1775](https://github.com/dbt-labs/dbt/pull/1715))
- Support asyncronous `compile_sql` and `run_sql` methods ([#1706](https://github.com/dbt-labs/dbt/issues/1706), [#1735](https://github.com/dbt-labs/dbt/pull/1735))
- Improve re-compilation performance ([#1824](https://github.com/dbt-labs/dbt/issues/1824), [#1830](https://github.com/dbt-labs/dbt/pull/1830))

### Postgres / Redshift

- Support running dbt against schemas which contain materialized views on Postgres ([#1698](https://github.com/dbt-labs/dbt/issues/1698), [#1833](https://github.com/dbt-labs/dbt/pull/1833))
- Support distyle AUTO in Redshift model configs ([#1882](https://github.com/dbt-labs/dbt/issues/1882), [#1885](https://github.com/dbt-labs/dbt/pull/1885)) ([docs](https://docs.getdbt.com/v0.15/docs/redshift-configs#section-using-sortkey-and-distkey))
- Fix for internal errors when run against mixed-case logical databases ([#1800](https://github.com/dbt-labs/dbt/issues/1800), [#1936](https://github.com/dbt-labs/dbt/pull/1936))

### Snowflake

- Support `copy grants` option in Snowflake model configs ([#1744](https://github.com/dbt-labs/dbt/issues/1744), [#1747](https://github.com/dbt-labs/dbt/pull/1747)) ([docs](https://docs.getdbt.com/v0.15/docs/snowflake-configs#section-copying-grants))
- Support warehouse configuration in Snowflake model configs ([#1358](https://github.com/dbt-labs/dbt/issues/1358), [#1899](https://github.com/dbt-labs/dbt/issues/1899), [#1788](https://github.com/dbt-labs/dbt/pull/1788), [#1901](https://github.com/dbt-labs/dbt/pull/1901)) ([docs](https://docs.getdbt.com/v0.15/docs/snowflake-configs#section-configuring-virtual-warehouses))
- Support secure views in Snowflake model configs ([#1730](https://github.com/dbt-labs/dbt/issues/1730), [#1743](https://github.com/dbt-labs/dbt/pull/1743)) ([docs](https://docs.getdbt.com/v0.15/docs/snowflake-configs#section-secure-views))
- Fix for unclosed connections preventing dbt from exiting when Snowflake is used with client_session_keep_alive ([#1271](https://github.com/dbt-labs/dbt/issues/1271), [#1749](https://github.com/dbt-labs/dbt/pull/1749))
- Fix for errors on Snowflake when dbt schemas contain `LOCAL TEMPORARY` tables ([#1869](https://github.com/dbt-labs/dbt/issues/1869), [#1872](https://github.com/dbt-labs/dbt/pull/1872))

### BigQuery

- Support KMS Encryption in BigQuery model configs ([#1829](https://github.com/dbt-labs/dbt/issues/1829), [#1851](https://github.com/dbt-labs/dbt/issues/1829)) ([docs](https://docs.getdbt.com/v0.15/docs/bigquery-configs#section-managing-kms-encryption))
- Improve docs generation speed by leveraging the information schema ([#1576](https://github.com/dbt-labs/dbt/issues/1576), [#1795](https://github.com/dbt-labs/dbt/pull/1795))
- Fix for cache errors on BigQuery when dataset names are capitalized ([#1810](https://github.com/dbt-labs/dbt/issues/1810), [#1881](https://github.com/dbt-labs/dbt/pull/1881))
- Fix for invalid query generation when multiple `options` are provided to a `create table|view` query ([#1786](https://github.com/dbt-labs/dbt/issues/1786), [#1787](https://github.com/dbt-labs/dbt/pull/1787))
- Use `client.delete_dataset` to drop BigQuery datasets atomically ([#1887](https://github.com/dbt-labs/dbt/issues/1887), [#1881](https://github.com/dbt-labs/dbt/pull/1881))

### Under the Hood

#### Dependencies

- Drop support for `networkx 1.x` ([#1577](https://github.com/dbt-labs/dbt/issues/1577), [#1814](https://github.com/dbt-labs/dbt/pull/1814))
- Upgrade `werkzeug` to 0.15.6 ([#1697](https://github.com/dbt-labs/dbt/issues/1697), [#1814](https://github.com/dbt-labs/dbt/pull/1814))
- Pin `psycopg2` dependency to 2.8.x to prevent segfaults ([#1221](https://github.com/dbt-labs/dbt/issues/1221), [#1898](https://github.com/dbt-labs/dbt/pull/1898))
- Set a strict upper bound for `jsonschema` dependency ([#1817](https://github.com/dbt-labs/dbt/issues/1817), [#1821](https://github.com/dbt-labs/dbt/pull/1821), [#1932](https://github.com/dbt-labs/dbt/pull/1932))

#### Everything else

- Provide test names and kwargs in the manifest ([#1154](https://github.com/dbt-labs/dbt/issues/1154), [#1816](https://github.com/dbt-labs/dbt/pull/1816))
- Replace JSON Schemas with data classes ([#1447](https://github.com/dbt-labs/dbt/issues/1447), [#1589](https://github.com/dbt-labs/dbt/pull/1589))
- Include test name and kwargs in test nodes in the manifest ([#1154](https://github.com/dbt-labs/dbt/issues/1154), [#1816](https://github.com/dbt-labs/dbt/pull/1816))
- Remove logic around handling `archive` blocks in the `dbt_project.yml` file ([#1580](https://github.com/dbt-labs/dbt/issues/1580), [#1581](https://github.com/dbt-labs/dbt/pull/1581))
- Remove the APIObject class ([#1762](https://github.com/dbt-labs/dbt/issues/1762), [#1780](https://github.com/dbt-labs/dbt/pull/1780))

## Contributors

Thanks all for your contributions to dbt! :tada:

- [@captainEli](https://github.com/captainEli) ([#1809](https://github.com/dbt-labs/dbt/pull/1809))
- [@clausherther](https://github.com/clausherther) ([#1876](https://github.com/dbt-labs/dbt/pull/1876))
- [@jtcohen6](https://github.com/jtcohen6) ([#1784](https://github.com/dbt-labs/dbt/pull/1784))
- [@tbescherer](https://github.com/tbescherer) ([#1515](https://github.com/dbt-labs/dbt/pull/1515))
- [@aminamos](https://github.com/aminamos) ([#1609](https://github.com/dbt-labs/dbt/pull/1609))
- [@JusLarsen](https://github.com/JusLarsen) ([#1903](https://github.com/dbt-labs/dbt/pull/1903))
- [@heisencoder](https://github.com/heisencoder) ([#1823](https://github.com/dbt-labs/dbt/pull/1823))
- [@tjengel](https://github.com/tjengel) ([#1885](https://github.com/dbt-labs/dbt/pull/1885))
- [@Carolus-Holman](https://github.com/tjengel) ([#1747](https://github.com/dbt-labs/dbt/pull/1747), [#1743](https://github.com/dbt-labs/dbt/pull/1743))
- [@kconvey](https://github.com/tjengel) ([#1851](https://github.com/dbt-labs/dbt/pull/1851))
- [@darrenhaken](https://github.com/darrenhaken) ([#1787](https://github.com/dbt-labs/dbt/pull/1787))

## dbt 0.14.4 (November 8, 2019)

This release changes the version ranges of some of dbt's dependencies. These changes address installation issues in 0.14.3 when dbt is installed from pip. You can view the full list of dependency version changes [in this commit](https://github.com/dbt-labs/dbt/commit/b4dd265cb433480a59bbd15d140d46ebf03644eb).
...
- Fix dependency issues caused by a bad release of `snowflake-connector-python` ([#1892](https://github.com/dbt-labs/dbt/issues/1892), [#1895](https://github.com/dbt-labs/dbt/pull/1895/files))
...
- Fix for `dictionary changed size during iteration` race condition ([#1740](https://github.com/dbt-labs/dbt/issues/1740), [#1750](https://github.com/dbt-labs/dbt/pull/1750))
- Fix upper bound on jsonschema dependency to 3.1.1 ([#1817](https://github.com/dbt-labs/dbt/issues/1817), [#1819](https://github.com/dbt-labs/dbt/pull/1819))

### Under the hood:

- Provide a programmatic method for validating profile targets ([#1754](https://github.com/dbt-labs/dbt/issues/1754), [#1775](https://github.com/dbt-labs/dbt/pull/1775))
...
- Fix for dbt hanging at the end of execution in `dbt source snapshot-freshness` tasks ([#1728](https://github.com/dbt-labs/dbt/issues/1728), [#1729](https://github.com/dbt-labs/dbt/pull/1729))
- Fix for broken "packages" and "tags" selector dropdowns in the dbt Documentation website ([docs#47](https://github.com/dbt-labs/dbt-docs/issues/47), [#1726](https://github.com/dbt-labs/dbt/pull/1726))

## dbt 0.14.1 (September 3, 2019)

### Overview

This is primarily a bugfix release which contains a few minor improvements too. Note: this release includes an important change in how the `check` snapshot strategy works. See [#1614](https://github.com/dbt-labs/dbt/pull/1614) for more information. If you are using snapshots with the `check` strategy on dbt v0.14.0, it is strongly recommended that you upgrade to 0.14.1 at your soonest convenience.

### Breaking changes

- The undocumented `macros` attribute was removed from the `graph` context variable ([#1615](https://github.com/dbt-labs/dbt/pull/1615))

### Features:

- Summarize warnings at the end of dbt runs ([#1597](https://github.com/dbt-labs/dbt/issues/1597), [#1654](https://github.com/dbt-labs/dbt/pull/1654))
- Speed up catalog generation on postgres by using avoiding use of the `information_schema` ([#1540](https://github.com/dbt-labs/dbt/pull/1540))
- Docs site updates ([#1621](https://github.com/dbt-labs/dbt/issues/1621))
...
- Add environment variables for macro debugging flags ([#1628](https://github.com/dbt-labs/dbt/issues/1628), [#1629](https://github.com/dbt-labs/dbt/pull/1629))
- Speed up node selection by making it linear, rather than quadratic, in complexity ([#1611](https://github.com/dbt-labs/dbt/issues/1611), [#1615](https://github.com/dbt-labs/dbt/pull/1615))
- Specify the `application` field in Snowflake connections ([#1622](https://github.com/dbt-labs/dbt/issues/1622), [#1623](https://github.com/dbt-labs/dbt/pull/1623))
- Add support for clustering on Snowflake ([#634](https://github.com/dbt-labs/dbt/issues/634), [#1591](https://github.com/dbt-labs/dbt/pull/1591), [#1689](https://github.com/dbt-labs/dbt/pull/1689)) ([docs](https://docs.getdbt.com/docs/snowflake-configs#section-configuring-table-clustering))
- Add support for job priority on BigQuery ([#1456](https://github.com/dbt-labs/dbt/issues/1456), [#1673](https://github.com/dbt-labs/dbt/pull/1673)) ([docs](https://docs.getdbt.com/docs/profile-bigquery#section-priority))
- Add `node.config` and `node.tags` to the `generate_schema_name` and `generate_alias_name` macro context ([#1700](https://github.com/dbt-labs/dbt/issues/1700), [#1701](https://github.com/dbt-labs/dbt/pull/1701))

### Fixes:

- Fix for reused `check_cols` values in snapshots ([#1614](https://github.com/dbt-labs/dbt/pull/1614), [#1709](https://github.com/dbt-labs/dbt/pull/1709))
- Fix for rendering column descriptions in sources ([#1619](https://github.com/dbt-labs/dbt/issues/1619), [#1633](https://github.com/dbt-labs/dbt/pull/1633))
- Fix for `is_incremental()` returning True for models that are not materialized as incremental models ([#1249](https://github.com/dbt-labs/dbt/issues/1249), [#1608](https://github.com/dbt-labs/dbt/pull/1608))
- Fix for serialization of BigQuery results which contain nested or repeated records ([#1626](https://github.com/dbt-labs/dbt/issues/1626), [#1638](https://github.com/dbt-labs/dbt/pull/1638))
- Fix for loading seed files which contain non-ascii characters ([#1632](https://github.com/dbt-labs/dbt/issues/1632), [#1644](https://github.com/dbt-labs/dbt/pull/1644))
- Fix for creation of user cookies in incorrect directories when `--profile-dir` or `$DBT_PROFILES_DIR` is provided ([#1645](https://github.com/dbt-labs/dbt/issues/1645), [#1656](https://github.com/dbt-labs/dbt/pull/1656))
- Fix for error handling when transactions are being rolled back ([#1647](https://github.com/dbt-labs/dbt/pull/1647))
- Fix for incorrect references to `dbt.exceptions` in jinja code ([#1569](https://github.com/dbt-labs/dbt/issues/1569), [#1609](https://github.com/dbt-labs/dbt/pull/1609))
- Fix for duplicated schema creation due to case-sensitive comparison ([#1651](https://github.com/dbt-labs/dbt/issues/1651), [#1663](https://github.com/dbt-labs/dbt/pull/1663))
- Fix for "schema stub" created automatically by dbt ([#913](https://github.com/dbt-labs/dbt/issues/913), [#1663](https://github.com/dbt-labs/dbt/pull/1663))
- Fix for incremental merge query on old versions of postgres (<=9.6) ([#1665](https://github.com/dbt-labs/dbt/issues/1665), [#1666](https://github.com/dbt-labs/dbt/pull/1666))
- Fix for serializing results of queries which return `TIMESTAMP_TZ` columns on Snowflake in the RPC server ([#1670](https://github.com/dbt-labs/dbt/pull/1670))
- Fix typo in InternalException ([#1640](https://github.com/dbt-labs/dbt/issues/1640), [#1672](https://github.com/dbt-labs/dbt/pull/1672))
- Fix typo in CLI help for snapshot migration subcommand ([#1664](https://github.com/dbt-labs/dbt/pull/1664))
- Fix for error handling logic when empty queries are submitted on Snowflake ([#1693](https://github.com/dbt-labs/dbt/issues/1693), [#1694](https://github.com/dbt-labs/dbt/pull/1694))
- Fix for non-atomic column expansion logic in Snowflake incremental models and snapshots ([#1687](https://github.com/dbt-labs/dbt/issues/1687), [#1690](https://github.com/dbt-labs/dbt/pull/1690))
- Fix for unprojected `count(*)` expression injected by custom data tests ([#1688](https://github.com/dbt-labs/dbt/pull/1688))
- Fix for `dbt run` and `dbt docs generate` commands when running against Panoply Redshift ([#1479](https://github.com/dbt-labs/dbt/issues/1479), [#1686](https://github.com/dbt-labs/dbt/pull/1686))

### Contributors:

Thanks for your contributions to dbt!

- [@levimalott](https://github.com/levimalott) ([#1647](https://github.com/dbt-labs/dbt/pull/1647))
- [@aminamos](https://github.com/aminamos) ([#1609](https://github.com/dbt-labs/dbt/pull/1609))
- [@elexisvenator](https://github.com/elexisvenator) ([#1540](https://github.com/dbt-labs/dbt/pull/1540))
- [@edmundyan](https://github.com/edmundyan) ([#1663](https://github.com/dbt-labs/dbt/pull/1663))
- [@vitorbaptista](https://github.com/vitorbaptista) ([#1664](https://github.com/dbt-labs/dbt/pull/1664))
- [@sjwhitworth](https://github.com/sjwhitworth) ([#1672](https://github.com/dbt-labs/dbt/pull/1672), [#1673](https://github.com/dbt-labs/dbt/pull/1673))
- [@mikaelene](https://github.com/mikaelene) ([#1688](https://github.com/dbt-labs/dbt/pull/1688), [#1709](https://github.com/dbt-labs/dbt/pull/1709))
- [@bastienboutonnet](https://github.com/bastienboutonnet) ([#1591](https://github.com/dbt-labs/dbt/pull/1591), [#1689](https://github.com/dbt-labs/dbt/pull/1689))
...
- Stub out adapter methods at parse-time to speed up parsing ([#1413](https://github.com/dbt-labs/dbt/pull/1413))
- Removed support for the `--non-destructive` flag ([#1419](https://github.com/dbt-labs/dbt/pull/1419), [#1415](https://github.com/dbt-labs/dbt/issues/1415))
- Removed support for the `sql_where` config to incremental models ([#1408](https://github.com/dbt-labs/dbt/pull/1408), [#1351](https://github.com/dbt-labs/dbt/issues/1351))
- Changed `expand_target_column_types` to take a Relation instead of a string ([#1478](https://github.com/dbt-labs/dbt/pull/1478))
- Replaced Archives with Snapshots
  - Normalized meta-column names in Snapshot tables ([#1361](https://github.com/dbt-labs/dbt/pull/1361), [#251](https://github.com/dbt-labs/dbt/issues/251))

### Features

- Add `run-operation` command which invokes macros directly from the CLI ([#1328](https://github.com/dbt-labs/dbt/pull/1328)) ([docs](https://docs.getdbt.com/v0.14/docs/run-operation))
- Add a `dbt ls` command which lists resources in your project ([#1436](https://github.com/dbt-labs/dbt/pull/1436), [#467](https://github.com/dbt-labs/dbt/issues/467)) ([docs](https://docs.getdbt.com/v0.14/docs/list))
- Add Snapshots, an improvement over Archives ([#1361](https://github.com/dbt-labs/dbt/pull/1361), [#1175](https://github.com/dbt-labs/dbt/issues/1175)) ([docs](https://docs.getdbt.com/v0.14/docs/snapshots))
  - Add the 'check' snapshot strategy ([#1361](https://github.com/dbt-labs/dbt/pull/1361), [#706](https://github.com/dbt-labs/dbt/issues/706))
  - Support Snapshots across logical databases ([#1455](https://github.com/dbt-labs/dbt/issues/1455))
  - Implement Snapshots using a merge statement where supported ([#1478](https://github.com/dbt-labs/dbt/pull/1478))
  - Support Snapshot selection using `--select` ([#1520](https://github.com/dbt-labs/dbt/pull/1520), [#1512](https://github.com/dbt-labs/dbt/issues/1512))
- Add an RPC server via `dbt rpc` ([#1301](https://github.com/dbt-labs/dbt/pull/1301), [#1274](https://github.com/dbt-labs/dbt/issues/1274)) ([docs](https://docs.getdbt.com/v0.14/docs/rpc))
  - Add `ps` and `kill` commands to the rpc server ([#1380](https://github.com/dbt-labs/dbt/pull/1380/), [#1369](https://github.com/dbt-labs/dbt/issues/1369), [#1370](https://github.com/dbt-labs/dbt/issues/1370))
  - Add support for ephemeral nodes to the rpc server ([#1373](https://github.com/dbt-labs/dbt/pull/1373), [#1368](https://github.com/dbt-labs/dbt/issues/1368))
  - Add support for inline macros to the rpc server ([#1375](https://github.com/dbt-labs/dbt/pull/1375), [#1372](https://github.com/dbt-labs/dbt/issues/1372), [#1348](https://github.com/dbt-labs/dbt/pull/1348))
  - Improve error handling in the rpc server ([#1341](https://github.com/dbt-labs/dbt/pull/1341), [#1309](https://github.com/dbt-labs/dbt/issues/1309), [#1310](https://github.com/dbt-labs/dbt/issues/1310))
- Made printer width configurable ([#1026](https://github.com/dbt-labs/dbt/issues/1026), [#1247](https://github.com/dbt-labs/dbt/pull/1247)) ([docs](https://docs.getdbt.com/v0.14/docs/configure-your-profile#section-additional-profile-configurations))
- Retry package downloads from the hub.getdbt.com ([#1451](https://github.com/dbt-labs/dbt/issues/1451), [#1491](https://github.com/dbt-labs/dbt/pull/1491))
- Add a test "severity" level, presented as a keyword argument to schema tests ([#1410](https://github.com/dbt-labs/dbt/pull/1410), [#1005](https://github.com/dbt-labs/dbt/issues/1005)) ([docs](https://docs.getdbt.com/v0.14/docs/testing#section-test-severity))
- Add a `generate_alias_name` macro to configure alias names dynamically ([#1363](https://github.com/dbt-labs/dbt/pull/1363)) ([docs](https://docs.getdbt.com/v0.14/docs/using-custom-aliases#section-generate_alias_name))
- Add a `node` argument to `generate_schema_name` to configure schema names dynamically ([#1483](https://github.com/dbt-labs/dbt/pull/1483), [#1463](https://github.com/dbt-labs/dbt/issues/1463)) ([docs](https://docs.getdbt.com/v0.14/docs/using-custom-schemas#section-generate_schema_name-arguments))
- Use `create or replace` on Snowflake to rebuild tables and views atomically ([#1101](https://github.com/dbt-labs/dbt/issues/1101), [#1409](https://github.com/dbt-labs/dbt/pull/1409))
- Use `merge` statement for incremental models on Snowflake ([#1414](https://github.com/dbt-labs/dbt/issues/1414), [#1307](https://github.com/dbt-labs/dbt/pull/1307), [#1409](https://github.com/dbt-labs/dbt/pull/1409)) ([docs](https://docs.getdbt.com/v0.14/docs/snowflake-configs#section-merge-behavior-incremental-models-))
- Add support seed CSV files that start with a UTF-8 Byte Order Mark (BOM) ([#1452](https://github.com/dbt-labs/dbt/pull/1452), [#1177](https://github.com/dbt-labs/dbt/issues/1177))
- Add a warning when git packages are not pinned to a version ([#1453](https://github.com/dbt-labs/dbt/pull/1453), [#1446](https://github.com/dbt-labs/dbt/issues/1446))
- Add logging for `on-run-start` and `on-run-end hooks` to console output ([#1440](https://github.com/dbt-labs/dbt/pull/1440), [#696](https://github.com/dbt-labs/dbt/issues/696))
- Add modules and tracking information to the rendering context for configuration files ([#1441](https://github.com/dbt-labs/dbt/pull/1441), [#1320](https://github.com/dbt-labs/dbt/issues/1320))
- Add support for `null` vars, and distinguish `null` vars from unset vars ([#1426](https://github.com/dbt-labs/dbt/pull/1426), [#608](https://github.com/dbt-labs/dbt/issues/608))
- Add support for the `search_path` configuration in Postgres/Redshift profiles ([#1477](https://github.com/dbt-labs/dbt/issues/1477), [#1476](https://github.com/dbt-labs/dbt/pull/1476)) ([docs (postgres)](https://docs.getdbt.com/v0.14/docs/profile-postgres), [docs (redshift)](https://docs.getdbt.com/v0.14/docs/profile-redshift))
- Add support for persisting documentation as `descriptions` for tables and views on BigQuery ([#1031](https://github.com/dbt-labs/dbt/issues/1031), [#1285](https://github.com/dbt-labs/dbt/pull/1285)) ([docs](https://docs.getdbt.com/v0.14/docs/bigquery-configs#section-persisting-model-descriptions))
- Add a `--project-dir` path which will invoke dbt in the specified directory ([#1549](https://github.com/dbt-labs/dbt/pull/1549), [#1544](https://github.com/dbt-labs/dbt/issues/1544))
...
- Fix for unduly long timeouts when anonymous event tracking is blocked ([#1445](https://github.com/dbt-labs/dbt/pull/1445), [#1063](https://github.com/dbt-labs/dbt/issues/1063))
- Fix for error with mostly-duplicate git urls in packages, picking the one that came first. ([#1428](https://github.com/dbt-labs/dbt/pull/1428), [#1084](https://github.com/dbt-labs/dbt/issues/1084))
- Fix for unrendered `description` field as jinja in top-level Source specification ([#1484](https://github.com/dbt-labs/dbt/issues/1484), [#1494](https://github.com/dbt-labs/dbt/issues/1494))
- Fix for API error when very large temp tables are created in BigQuery ([#1423](https://github.com/dbt-labs/dbt/issues/1423), [#1478](https://github.com/dbt-labs/dbt/pull/1478))
- Fix for compiler errors that occurred if jinja code was present outside of a docs blocks in .md files ([#1513](https://github.com/dbt-labs/dbt/pull/1513), [#988](https://github.com/dbt-labs/dbt/issues/988))
- Fix `TEXT` handling on postgres and redshift ([#1420](https://github.com/dbt-labs/dbt/pull/1420), [#781](https://github.com/dbt-labs/dbt/issues/781))
- Fix for compiler error when vars are undefined but only used in disabled models ([#1429](https://github.com/dbt-labs/dbt/pull/1429), [#434](https://github.com/dbt-labs/dbt/issues/434))
- Improved the error message when iterating over the results of a macro that doesn't exist ([#1425](https://github.com/dbt-labs/dbt/pull/1425), [#1424](https://github.com/dbt-labs/dbt/issues/1424))
- Improved the error message when tests have invalid parameter definitions ([#1427](https://github.com/dbt-labs/dbt/pull/1427), [#1325](https://github.com/dbt-labs/dbt/issues/1325))
- Improved the error message when a user tries to archive a non-existent table ([#1361](https://github.com/dbt-labs/dbt/pull/1361), [#1066](https://github.com/dbt-labs/dbt/issues/1066))
- Fix for archive logic which tried to create already-existing destination schemas ([#1398](https://github.com/dbt-labs/dbt/pull/1398), [#758](https://github.com/dbt-labs/dbt/issues/758))
- Fix for incorrect error codes when Operations exit with an error ([#1406](https://github.com/dbt-labs/dbt/pull/1406), [#1377](https://github.com/dbt-labs/dbt/issues/1377))
- Fix for missing compiled SQL when the rpc server encounters a database error ([#1381](https://github.com/dbt-labs/dbt/pull/1381), [#1371](https://github.com/dbt-labs/dbt/issues/1371))
- Fix for broken link in the profile.yml generated by `dbt init` ([#1366](https://github.com/dbt-labs/dbt/pull/1366), [#1344](https://github.com/dbt-labs/dbt/issues/1344))
- Fix the sample test.env file's redshift password field ([#1364](https://github.com/dbt-labs/dbt/pull/1364))
- Fix collisions on models running concurrently that have duplicate names but have distinguishing aliases ([#1342](https://github.com/dbt-labs/dbt/pull/1342), [#1321](https://github.com/dbt-labs/dbt/issues/1321))
- Fix for a bad error message when a `version` is missing from a package spec in `packages.yml` ([#1551](https://github.com/dbt-labs/dbt/pull/1551), [#1546](https://github.com/dbt-labs/dbt/issues/1546))
- Fix for wrong package scope when the two-arg method of `ref` is used ([#1515](https://github.com/dbt-labs/dbt/pull/1515), [#1504](https://github.com/dbt-labs/dbt/issues/1504))
- Fix missing import in test suite ([#1572](https://github.com/dbt-labs/dbt/pull/1572))
- Fix for a Snowflake error when an external table exists in a schema that dbt operates on ([#1571](https://github.com/dbt-labs/dbt/pull/1571), [#1505](https://github.com/dbt-labs/dbt/issues/1505))

### Under the hood

- Use pytest for tests ([#1417](https://github.com/dbt-labs/dbt/pull/1417))
- Use flake8 for linting ([#1361](https://github.com/dbt-labs/dbt/pull/1361), [#1333](https://github.com/dbt-labs/dbt/issues/1333))
- Added a flag for wrapping models and tests in jinja blocks ([#1407](https://github.com/dbt-labs/dbt/pull/1407), [#1400](https://github.com/dbt-labs/dbt/issues/1400))
- Connection management: Bind connections threads rather than to names ([#1336](https://github.com/dbt-labs/dbt/pull/1336), [#1312](https://github.com/dbt-labs/dbt/issues/1312))
- Add deprecation warning for dbt users on Python2 ([#1534](https://github.com/dbt-labs/dbt/pull/1534), [#1531](https://github.com/dbt-labs/dbt/issues/1531))
- Upgrade networkx to v2.x ([#1509](https://github.com/dbt-labs/dbt/pull/1509), [#1496](https://github.com/dbt-labs/dbt/issues/1496))
- Anonymously track adapter type and rpc requests when tracking is enabled ([#1575](https://github.com/dbt-labs/dbt/pull/1575), [#1574](https://github.com/dbt-labs/dbt/issues/1574))
- Fix for test warnings and general test suite cleanup ([#1578](https://github.com/dbt-labs/dbt/pull/1578))

### Contributors:

Over a dozen contributors wrote code for this release of dbt! Thanks for taking the time, and nice work y'all! :)

- [@nydnarb](https://github.com/nydnarb) ([#1363](https://github.com/dbt-labs/dbt/issues/1363))
- [@emilieschario](https://github.com/emilieschario) ([#1366](https://github.com/dbt-labs/dbt/pull/1366))
- [@bastienboutonnet](https://github.com/bastienboutonnet) ([#1409](https://github.com/dbt-labs/dbt/pull/1409))
- [@kasanchez](https://github.com/kasanchez) ([#1247](https://github.com/dbt-labs/dbt/pull/1247))
- [@Blakewell](https://github.com/Blakewell) ([#1307](https://github.com/dbt-labs/dbt/pull/1307))
- [@buremba](https://github.com/buremba) ([#1476](https://github.com/dbt-labs/dbt/pull/1476))
- [@darrenhaken](https://github.com/darrenhaken) ([#1285](https://github.com/dbt-labs/dbt/pull/1285))
- [@tbescherer](https://github.com/tbescherer) ([#1504](https://github.com/dbt-labs/dbt/issues/1504))
- [@heisencoder](https://github.com/heisencoder) ([#1509](https://github.com/dbt-labs/dbt/pull/1509), [#1549](https://github.com/dbt-labs/dbt/pull/1549). [#1578](https://github.com/dbt-labs/dbt/pull/1578))
- [@cclauss](https://github.com/cclauss) ([#1572](https://github.com/dbt-labs/dbt/pull/1572))
- [@josegalarza](https://github.com/josegalarza) ([#1571](https://github.com/dbt-labs/dbt/pull/1571))
...
- [@dcereijodo](https://github.com/dcereijodo) ([#2341](https://github.com/dbt-labs/dbt/pull/2341))
...
- Add "MaterializedView" relation type to the Snowflake adapter ([#1430](https://github.com/dbt-labs/dbt/issues/1430), [#1432](https://github.com/dbt-labs/dbt/pull/1432)) ([@adriank-convoy](https://github.com/adriank-convoy))
- Quote databases properly ([#1396](https://github.com/dbt-labs/dbt/issues/1396), [#1402](https://github.com/dbt-labs/dbt/pull/1402))
- Use "ilike" instead of "=" for database equality when listing schemas ([#1411](https://github.com/dbt-labs/dbt/issues/1411), [#1412](https://github.com/dbt-labs/dbt/pull/1412))
- Pass the model name along in get_relations ([#1384](https://github.com/dbt-labs/dbt/issues/1384), [#1388](https://github.com/dbt-labs/dbt/pull/1388))
- Add logging to dbt clean ([#1261](https://github.com/dbt-labs/dbt/issues/1261), [#1383](https://github.com/dbt-labs/dbt/pull/1383), [#1391](https://github.com/dbt-labs/dbt/pull/1391)) ([@emilieschario](https://github.com/emilieschario))
...
- `{{this}}` is no longer implemented for `on-run-start` and `on-run-end` hooks. Use `{{ target }}` or an [`on-run-end` context variable](https://docs.getdbt.com/docs/on-run-end-context#section-schemas) instead ([#1176](https://github.com/dbt-labs/dbt/pull/1176), implementing [#878](https://github.com/dbt-labs/dbt/issues/878))
...
- Add `source`s to dbt, use them to calculate source data freshness ([docs](https://docs.getdbt.com/v0.13/docs/using-sources) ) ([#814](https://github.com/dbt-labs/dbt/issues/814), [#1240](https://github.com/dbt-labs/dbt/issues/1240))
- Add support for Presto ([docs](https://docs.getdbt.com/v0.13/docs/profile-presto), [repo](https://github.com/dbt-labs/dbt-presto)) ([#1106](https://github.com/dbt-labs/dbt/issues/1106))
- Add `require-dbt-version` option to `dbt_project.yml` to state the supported versions of dbt for packages ([docs](https://docs.getdbt.com/v0.13/docs/requiring-dbt-versions)) ([#581](https://github.com/dbt-labs/dbt/issues/581))
- Add an output line indicating the installed version of dbt to every run ([#1134](https://github.com/dbt-labs/dbt/issues/1134))
- Add a new model selector (`@`) which build models, their children, and their children's parents ([docs](https://docs.getdbt.com/v0.13/reference#section-the-at-operator)) ([#1156](https://github.com/dbt-labs/dbt/issues/1156))
- Add support for Snowflake Key Pair Authentication ([docs](https://docs.getdbt.com/v0.13/docs/profile-snowflake#section-key-pair-authentication)) ([#1232](https://github.com/dbt-labs/dbt/pull/1232))
- Support SSO Authentication for Snowflake ([docs](https://docs.getdbt.com/v0.13/docs/profile-snowflake#section-sso-authentication)) ([#1172](https://github.com/dbt-labs/dbt/issues/1172))
- Add support for Snowflake's transient tables ([docs](https://docs.getdbt.com/v0.13/docs/snowflake-configs#section-transient-tables)) ([#946](https://github.com/dbt-labs/dbt/issues/946))
- Capture build timing data in `run_results.json` to visualize project performance ([#1179](https://github.com/dbt-labs/dbt/issues/1179))
- Add CLI flag to toggle warnings as errors ([docs](https://docs.getdbt.com/v0.13/reference#section-treat-warnings-as-errors)) ([#1243](https://github.com/dbt-labs/dbt/issues/1243))
- Add tab completion script for Bash ([docs](https://github.com/dbt-labs/dbt-completion.bash)) ([#1197](https://github.com/dbt-labs/dbt/issues/1197))
- Added docs on how to build a new adapter ([docs](https://docs.getdbt.com/v0.13/docs/building-a-new-adapter)) ([#560](https://github.com/dbt-labs/dbt/issues/560))
- Use new logo ([#1349](https://github.com/dbt-labs/dbt/pull/1349))

### Fixes

- Fix for Postgres character columns treated as string types ([#1194](https://github.com/dbt-labs/dbt/issues/1194))
- Fix for hard to reach edge case in which dbt could hang ([#1223](https://github.com/dbt-labs/dbt/issues/1223))
- Fix for `dbt deps` in non-English shells ([#1222](https://github.com/dbt-labs/dbt/issues/1222))
- Fix for over eager schema creation when models are run with `--models` ([#1239](https://github.com/dbt-labs/dbt/issues/1239))
- Fix for `dbt seed --show` ([#1288](https://github.com/dbt-labs/dbt/issues/1288))
- Fix for `is_incremental()` which should only return `True` if the target relation is a `table` ([#1292](https://github.com/dbt-labs/dbt/issues/1292))
- Fix for error in Snowflake table materializations with custom schemas ([#1316](https://github.com/dbt-labs/dbt/issues/1316))
- Fix errored out concurrent transactions on Redshift and Postgres ([#1356](https://github.com/dbt-labs/dbt/pull/1356))
- Fix out of order execution on model select ([#1354](https://github.com/dbt-labs/dbt/issues/1354), [#1355](https://github.com/dbt-labs/dbt/pull/1355))
- Fix adapter macro namespace issue ([#1352](https://github.com/dbt-labs/dbt/issues/1352), [#1353](https://github.com/dbt-labs/dbt/pull/1353))
- Re-add CLI flag to toggle warnings as errors ([#1347](https://github.com/dbt-labs/dbt/pull/1347))
- Fix release candidate regression that runs run hooks on test invocations ([#1346](https://github.com/dbt-labs/dbt/pull/1346))
- Fix Snowflake source quoting ([#1338](https://github.com/dbt-labs/dbt/pull/1338), [#1317](https://github.com/dbt-labs/dbt/issues/1317), [#1332](https://github.com/dbt-labs/dbt/issues/1332))
- Handle unexpected max_loaded_at types ([#1330](https://github.com/dbt-labs/dbt/pull/1330))

### Under the hood

- Replace all SQL in Python code with Jinja in macros ([#1204](https://github.com/dbt-labs/dbt/issues/1204))
- Loosen restrictions of boto3 dependency ([#1234](https://github.com/dbt-labs/dbt/issues/1234))
- Rewrote Postgres introspective queries to be faster on large databases ([#1192](https://github.com/dbt-labs/dbt/issues/1192)

### Contributors:

Thanks for your contributions to dbt!

- [@patrickgoss](https://github.com/patrickgoss) [#1193](https://github.com/dbt-labs/dbt/issues/1193)
- [@brianhartsock](https://github.com/brianhartsock) [#1191](https://github.com/dbt-labs/dbt/pull/1191)
- [@alexyer](https://github.com/alexyer) [#1232](https://github.com/dbt-labs/dbt/pull/1232)
- [@adriank-convoy](https://github.com/adriank-convoy) [#1224](https://github.com/dbt-labs/dbt/pull/1224)
- [@mikekaminsky](https://github.com/mikekaminsky) [#1216](https://github.com/dbt-labs/dbt/pull/1216)
- [@vijaykiran](https://github.com/vijaykiran) [#1198](https://github.com/dbt-labs/dbt/pull/1198), [#1199](https://github.com/dbt-labs/dbt/pull/1199)
...
- Deprecate `sql_where` ([#744](https://github.com/dbt-labs/dbt/issues/744)) ([docs](https://docs.getdbt.com/v0.12/docs/configuring-incremental-models))

### Features

- More intelligently order and execute nodes in the graph. This _significantly_ speeds up the runtime of most dbt projects ([#813](https://github.com/dbt-labs/dbt/issues/813))
- Add `-m` flag as an alias for `--models` ([#1160](https://github.com/dbt-labs/dbt/issues/1160))
- Add `post_hook` and `pre_hook` as aliases for `post-hook` and `pre-hook`, respectively ([#1124](https://github.com/dbt-labs/dbt/issues/1124)) ([docs](https://docs.getdbt.com/v0.12/docs/using-hooks))
- Better handling of git errors in `dbt deps` + full support for Windows ([#994](https://github.com/dbt-labs/dbt/issues/994), [#778](https://github.com/dbt-labs/dbt/issues/778), [#895](https://github.com/dbt-labs/dbt/issues/895))
- Add support for specifying a `location` in BigQuery datasets ([#969](https://github.com/dbt-labs/dbt/issues/969)) ([docs](https://docs.getdbt.com/v0.12/docs/supported-databases#section-dataset-locations))
- Add support for Jinja expressions using the `{% do ... %}` block ([#1113](https://github.com/dbt-labs/dbt/issues/1113))
- The `dbt debug` command is actually useful now ([#1061](https://github.com/dbt-labs/dbt/issues/1061))
- The `config` function can now be called multiple times in a model ([#558](https://github.com/dbt-labs/dbt/issues/558))
- Source the latest version of dbt from PyPi instead of GitHub ([#1122](https://github.com/dbt-labs/dbt/issues/1122))
- Add a peformance profiling mechnanism to dbt ([#1001](https://github.com/dbt-labs/dbt/issues/1001))
- Add caching for dbt's macros-only manifest to speedup parsing ([#1098](https://github.com/dbt-labs/dbt/issues/1098))

### Fixes

- Fix for custom schemas used alongside the `generate_schema_name` macro ([#801](https://github.com/dbt-labs/dbt/issues/801))
- Fix for silent failure of tests that reference nonexistent models ([#968](https://github.com/dbt-labs/dbt/issues/968))
- Fix for `generate_schema_name` macros that return whitespace-padded schema names ([#1074](https://github.com/dbt-labs/dbt/issues/1074))
- Fix for incorrect relation type for backup tables on Snowflake ([#1103](https://github.com/dbt-labs/dbt/issues/1103))
- Fix for incorrectly cased values in the relation cache ([#1140](https://github.com/dbt-labs/dbt/issues/1140))
- Fix for JSON decoding error on Python2 installed with Anaconda ([#1155](https://github.com/dbt-labs/dbt/issues/1155))
- Fix for unhandled exceptions that occur in anonymous event tracking ([#1180](https://github.com/dbt-labs/dbt/issues/1180))
- Fix for analysis files that contain `raw` tags ([#1152](https://github.com/dbt-labs/dbt/issues/1152))
- Fix for packages which reference the [hubsite](hub.getdbt.com) ([#1095](https://github.com/dbt-labs/dbt/issues/1095))
...
- Fix for relation caching when views outside of a dbt schema depend on relations inside of a dbt schema ([#1119](https://github.com/dbt-labs/dbt/issues/1119))
...
- Cache the existence of relations to speed up dbt runs ([#1025](https://github.com/dbt-labs/dbt/pull/1025))
- Add support for tag configuration and selection ([#1014](https://github.com/dbt-labs/dbt/pull/1014))
  - Add tags to the model and graph views in the docs UI ([#7](https://github.com/dbt-labs/dbt-docs/pull/7))
- Add the set of schemas that dbt built models into in the `on-run-end` hook context ([#908](https://github.com/dbt-labs/dbt/issues/908))
- Warn for unused resource config paths in dbt_project.yml ([#725](https://github.com/dbt-labs/dbt/pull/725))
- Add more information to the `dbt --help` output ([#1058](https://github.com/dbt-labs/dbt/issues/1058))
- Add support for configuring the profiles directory with an env var ([#1055](https://github.com/dbt-labs/dbt/issues/1055))
- Add support for cli and env vars in most `dbt_project.yml` and `profiles.yml` fields ([#1033](https://github.com/dbt-labs/dbt/pull/1033))
- Provide a better error message when seed file loading fails on BigQuery ([#1079](https://github.com/dbt-labs/dbt/pull/1079))
- Improved error handling and messaging on Redshift ([#997](https://github.com/dbt-labs/dbt/issues/997))
- Include datasets with underscores when listing BigQuery datasets ([#954](https://github.com/dbt-labs/dbt/pull/954))
- Forgo validating the user's profile for `dbt deps` and `dbt clean` commands ([#947](https://github.com/dbt-labs/dbt/issues/947), [#1022](https://github.com/dbt-labs/dbt/issues/1022))
- Don't read/parse CSV files outside of the `dbt seed` command ([#1046](https://github.com/dbt-labs/dbt/pull/1046))

### Fixes

- Fix for incorrect model selection with the `--models` CLI flag when projects and directories share the same name ([#1023](https://github.com/dbt-labs/dbt/issues/1023))
- Fix for table clustering configuration with multiple columns on BigQuery ([#1013](https://github.com/dbt-labs/dbt/issues/1013))
- Fix for incorrect output when a single row fails validation in `dbt test` ([#1040](https://github.com/dbt-labs/dbt/issues/1040))
- Fix for unwieldly Jinja errors regarding undefined variables at parse time ([#1086](https://github.com/dbt-labs/dbt/pull/1086), [#1080](https://github.com/dbt-labs/dbt/issues/1080), [#935](https://github.com/dbt-labs/dbt/issues/935))
- Fix for incremental models that have a line comment on the last line of the file ([#1018](https://github.com/dbt-labs/dbt/issues/1018))
- Fix for error messages when ephemeral models fail to compile ([#1053](https://github.com/dbt-labs/dbt/pull/1053))

### Under the hood

- Create adapters as singleton objects instead of classes ([#961](https://github.com/dbt-labs/dbt/issues/961))
- Combine project and profile into a single, coherent object ([#973](https://github.com/dbt-labs/dbt/pull/973))
- Investigate approaches for providing more complete compilation output ([#588](https://github.com/dbt-labs/dbt/issues/588))

### Contributors

Thanks for contributing!

- [@mikekaminsky](https://github.com/mikekaminsky) ([#1049](https://github.com/dbt-labs/dbt/pull/1049), [#1060](https://github.com/dbt-labs/dbt/pull/1060))
- [@joshtemple](https://github.com/joshtemple) ([#1079](https://github.com/dbt-labs/dbt/pull/1079))
- [@k4y3ff](https://github.com/k4y3ff) ([#954](https://github.com/dbt-labs/dbt/pull/954))
- [@elexisvenator](https://github.com/elexisvenator) ([#1019](https://github.com/dbt-labs/dbt/pull/1019))
- [@clrcrl](https://github.com/clrcrl) ([#725](https://github.com/dbt-labs/dbt/pull/725)
...
- dbt
  - Add `--port` parameter to dbt docs serve ([#987](https://github.com/dbt-labs/dbt/pull/987))

### Fixes

- dbt
  - Fix hooks in model configs not running ([#985](https://github.com/dbt-labs/dbt/pull/985))
  - Fix integration test on redshift catalog generation ([#977](https://github.com/dbt-labs/dbt/pull/977))
  - Snowflake: Fix docs generation errors when QUOTED_IDENTIFIER_IGNORE_CASE is set ([#998](https://github.com/dbt-labs/dbt/pull/998))
  - Translate empty strings to null in seeds ([#995](https://github.com/dbt-labs/dbt/pull/995))
  - Filter out null schemas during catalog generation ([#992](https://github.com/dbt-labs/dbt/pull/992))
  - Fix quoting on drop, truncate, and rename ([#991](https://github.com/dbt-labs/dbt/pull/991))
- dbt-docs
...
- Change default Snowflake quoting strategy to "unquoted" ([docs](https://docs.getdbt.com/v0.11/docs/configuring-quoting)) ([#824](https://github.com/dbt-labs/dbt/issues/824))

### Features

- Add autogenerated dbt project documentation ([docs](https://docs.getdbt.com/v0.11/docs/testing-and-documentation)) ([#375](https://github.com/dbt-labs/dbt/issues/375), [#863](https://github.com/dbt-labs/dbt/issues/863), [#941](https://github.com/dbt-labs/dbt/issues/941), [#815](https://github.com/dbt-labs/dbt/issues/815))
- Version 2 of schema.yml, which allows users to create table and column comments that end up in the manifest ([docs](https://docs.getdbt.com/v0.11/docs/schemayml-files)) ([#880](https://github.com/dbt-labs/dbt/pull/880))
- Extend catalog and manifest to also support Snowflake, BigQuery, and Redshift, in addition to existing Postgres support ([#866](https://github.com/dbt-labs/dbt/pull/866), [#857](https://github.com/dbt-labs/dbt/pull/857), [#849](https://github.com/dbt-labs/dbt/pull/849))
- Add a 'generated_at' field to both the manifest and the catalog. ([#887](https://github.com/dbt-labs/dbt/pull/877))
- Add `docs` blocks that users can put into `.md` files and `doc()` value for schema v2 description fields ([#888](https://github.com/dbt-labs/dbt/pull/888))
- Write out a 'run_results.json' after dbt invocations. ([#904](https://github.com/dbt-labs/dbt/pull/904))
- Type inference for interpreting CSV data is now less aggressive ([#905](https://github.com/dbt-labs/dbt/pull/905))
- Remove distinction between `this.table` and `this.schema` by refactoring materialization SQL ([#940](https://github.com/dbt-labs/dbt/pull/940))

### Fixes

- Fix for identifier clashes in BigQuery merge statements ([#914](https://github.com/dbt-labs/dbt/issues/914))
- Fix for unneccessary downloads of `bumpversion.cfg`, handle failures gracefully ([#907](https://github.com/dbt-labs/dbt/issues/907))
- Fix for incompatible `boto3` requirements ([#959](https://github.com/dbt-labs/dbt/issues/959))
- Fix for invalid `relationships` test when the parent column contains null values ([#921](https://github.com/dbt-labs/dbt/pull/921))

### Contributors

Thanks for contributing!

- [@rsmichaeldunn](https://github.com/rsmichaeldunn) ([#799](https://github.com/dbt-labs/dbt/pull/799))
- [@lewish](https://github.com/dbt-labs/dbt/pull/915) ([#915](https://github.com/dbt-labs/dbt/pull/915))
- [@MartinLue](https://github.com/MartinLue) ([#872](https://github.com/dbt-labs/dbt/pull/872))
...
- [@danielchalef](https://github.com/danielchalef) ([#818](https://github.com/dbt-labs/dbt/pull/818))
- [@mjumbewu](https://github.com/mjumbewu) ([#796](https://github.com/dbt-labs/dbt/pull/796))
- [@abelsonlive](https://github.com/abelsonlive) ([#800](https://github.com/dbt-labs/dbt/pull/800))
- [@jon-rtr](https://github.com/jon-rtr) ([#800](https://github.com/dbt-labs/dbt/pull/800))
- [@mturzanska](https://github.com/mturzanska) ([#797](https://github.com/dbt-labs/dbt/pull/797))
- [@cpdean](https://github.com/cpdean) ([#780](https://github.com/dbt-labs/dbt/pull/780))

### Features

- BigQuery
  - Support incremental models ([#856](https://github.com/dbt-labs/dbt/pull/856)) ([docs](https://docs.getdbt.com/docs/configuring-models#section-configuring-incremental-models))
  - Support archival ([#856](https://github.com/dbt-labs/dbt/pull/856)) ([docs](https://docs.getdbt.com/docs/archival))
  - Add pre/post hook support ([#836](https://github.com/dbt-labs/dbt/pull/836)) ([docs](https://docs.getdbt.com/docs/using-hooks))
- Redshift: IAM Auth ([#818](https://github.com/dbt-labs/dbt/pull/818)) ([docs](https://docs.getdbt.com/docs/supported-databases#section-iam-authentication))
- Model aliases ([#800](https://github.com/dbt-labs/dbt/pull/800))([docs](https://docs.getdbt.com/docs/using-custom-aliases))
- Write JSON manifest file to disk during compilation ([#761](https://github.com/dbt-labs/dbt/pull/761))
- Add forward and backward graph edges to the JSON manifest file ([#762](https://github.com/dbt-labs/dbt/pull/762))
- Add a 'dbt docs generate' command to generate a JSON catalog file ([#774](https://github.com/dbt-labs/dbt/pull/774), [#808](https://github.com/dbt-labs/dbt/pull/808))

### Bugfixes

- BigQuery: fix concurrent relation loads ([#835](https://github.com/dbt-labs/dbt/pull/835))
- BigQuery: support external relations ([#828](https://github.com/dbt-labs/dbt/pull/828))
- Redshift: set TCP keepalive on connections ([#826](https://github.com/dbt-labs/dbt/pull/826))
- Redshift: fix "table dropped by concurrent query" ([#825](https://github.com/dbt-labs/dbt/pull/825))
- Fix the error handling for profiles.yml validation ([#820](https://github.com/dbt-labs/dbt/pull/820))
- Make the `--threads` parameter actually change the number of threads used ([#819](https://github.com/dbt-labs/dbt/pull/819))
- Ensure that numeric precision of a column is not `None` ([#796](https://github.com/dbt-labs/dbt/pull/796))
- Allow for more complex version comparison ([#797](https://github.com/dbt-labs/dbt/pull/797))

### Changes

- Use a subselect instead of CTE when building incremental models ([#787](https://github.com/dbt-labs/dbt/pull/787))
- Internals
  - Improved dependency selection, rip out some unused dependencies ([#848](https://github.com/dbt-labs/dbt/pull/848))
  - Stop tracking `run_error` in tracking code ([#817](https://github.com/dbt-labs/dbt/pull/817))
  - Use Mapping instead of dict as the base class for APIObject ([#756](https://github.com/dbt-labs/dbt/pull/756))
  - Split out parsers ([#809](https://github.com/dbt-labs/dbt/pull/809))
  - Fix `__all__` parameter in submodules ([#780](https://github.com/dbt-labs/dbt/pull/780))
  - Switch to CircleCI 2.0 ([#843](https://github.com/dbt-labs/dbt/pull/843), [#850](https://github.com/dbt-labs/dbt/pull/850))
  - Added tox environments that have the user specify what tests should be run ([#837](https://github.com/dbt-labs/dbt/pull/837))
...
- Consistent schema and identifier quoting ([#727](https://github.com/dbt-labs/dbt/pull/727))
  - Configure quoting settings in the `dbt_project.yml` file ([#742](https://github.com/dbt-labs/dbt/pull/742))
  - Add a `Relation` object to the context to make quoting consistent and simple ([#742](https://github.com/dbt-labs/dbt/pull/742))
- Use the new `create table as (...)` syntax on BigQuery ([#717](https://github.com/dbt-labs/dbt/pull/717))
  - Support `partition by` clause
- CSV Updates:
  - Use floating point as default seed column type to avoid issues with type inference ([#694](https://github.com/dbt-labs/dbt/pull/694))
  - Provide a mechanism for overriding seed column types in the `dbt_project.yml` file ([#708](https://github.com/dbt-labs/dbt/pull/708))
  - Fix seeding for files with more than 16k rows on Snowflake ([#694](https://github.com/dbt-labs/dbt/pull/694))
  - Implement seeds using a materialization
- Improve `get_columns_in_table` context function ([#709](https://github.com/dbt-labs/dbt/pull/709))
...
- Fix for incorrect var precendence when using `--vars` on the CLI ([#739](https://github.com/dbt-labs/dbt/pull/739))
- Fix for closed connections in `on-run-end` hooks for long-running dbt invocations ([#693](https://github.com/dbt-labs/dbt/pull/693))
- Fix: don't try to run empty hooks ([#620](https://github.com/dbt-labs/dbt/issues/620), [#693](https://github.com/dbt-labs/dbt/pull/693))
- Fix: Prevent seed data from being serialized into `graph.gpickle` file ([#720](https://github.com/dbt-labs/dbt/pull/720))
- Fix: Disallow seed and model files with the same name ([#737](https://github.com/dbt-labs/dbt/pull/737))
...
- Support for variables defined on the CLI with `--vars` ([#640](https://github.com/dbt-labs/dbt/pull/640)) ([docs](https://docs.getdbt.com/docs/using-variables))
- Improvements to `dbt seed` ([docs](https://docs.getdbt.com/v0.10/reference#seed))
  - Support seeding csv files on all adapters ([#618](https://github.com/dbt-labs/dbt/pull/618))
  - Make seed csv's `ref()`-able in models ([#668](https://github.com/dbt-labs/dbt/pull/668))
  - Support seed file configuration (custom schemas, enabled / disabled) in the `dbt_project.yml` file ([#561](https://github.com/dbt-labs/dbt/issues/561))
  - Support `--full-refresh` instead of `--drop-existing` (deprecated) for seed files ([#515](https://github.com/dbt-labs/dbt/issues/515))
  - Add `--show` argument to `dbt seed` to display a sample of data in the CLI ([#74](https://github.com/dbt-labs/dbt/issues/74))
- Improvements to package management ([docs](https://docs.getdbt.com/docs/package-management))
  - Deprecated `repositories:` config option in favor of `packages:` ([#542](https://github.com/dbt-labs/dbt/pull/542))
  - Deprecated package listing in `dbt_project.yml` in favor of `packages.yml` ([#681](https://github.com/dbt-labs/dbt/pull/681))
  - Support stating local file paths as dependencies ([#542](https://github.com/dbt-labs/dbt/pull/542))
- Support date partitioning in BigQuery ([#641](https://github.com/dbt-labs/dbt/pull/641)) ([docs](https://docs.getdbt.com/docs/creating-date-partitioned-tables))
- Move schema creation to _after_ `on-run-start` hooks ([#652](https://github.com/dbt-labs/dbt/pull/652))
- Replace `csvkit` dependency with `agate` ([#598](https://github.com/dbt-labs/dbt/issues/598))
- Switch snowplow endpoint to pipe directly to Fishtown Analytics ([#682](https://github.com/dbt-labs/dbt/pull/682))

### Bugfixes

- Throw a compilation exception if a required test macro is not present in the context ([#655](https://github.com/dbt-labs/dbt/issues/655))
- Make the `adapter_macro` use the `return()` function ([#635](https://github.com/dbt-labs/dbt/issues/635))
- Fix bug for introspective query on late binding views (redshift) ([#647](https://github.com/dbt-labs/dbt/pull/647))
- Disable any non-dbt log output on the CLI ([#663](https://github.com/dbt-labs/dbt/pull/663))
...
- Support late binding views on Redshift ([#614](https://github.com/dbt-labs/dbt/pull/614)) ([docs](https://docs.getdbt.com/docs/warehouse-specific-configurations#section-late-binding-views))
- Make `run_started_at` timezone-aware ([#553](https://github.com/dbt-labs/dbt/pull/553)) (Contributed by [@mturzanska](https://github.com/mturzanska)) ([docs](https://docs.getdbt.com/v0.9/reference#run_started_at))

### Bugfixes

- Include hook run time in reported model run time ([#607](https://github.com/dbt-labs/dbt/pull/607))
- Add warning for missing test constraints ([#600](https://github.com/dbt-labs/dbt/pull/600))
- Fix for schema tests used or defined in packages ([#599](https://github.com/dbt-labs/dbt/pull/599))
- Run hooks in defined order ([#601](https://github.com/dbt-labs/dbt/pull/601))
- Skip tests that depend on nonexistent models ([#617](https://github.com/dbt-labs/dbt/pull/617))
- Fix for `adapter_macro` called within a package ([#630](https://github.com/dbt-labs/dbt/pull/630))
...
- Handle lingering `__dbt_tmp` relations ([#511](https://github.com/dbt-labs/dbt/pull/511))
- Run tests defined in an ephemeral directory ([#509](https://github.com/dbt-labs/dbt/pull/509))

### Changes

- use `adapter`, `ref`, and `var` inside of macros ([#466](https://github.com/dbt-labs/dbt/pull/466/files))
- Build custom tests and materializations in dbt packages ([#466](https://github.com/dbt-labs/dbt/pull/466/files))
- Support pre- and post- hooks that run outside of a transaction ([#510](https://github.com/dbt-labs/dbt/pull/510))
- Support table materializations for BigQuery ([#507](https://github.com/dbt-labs/dbt/pull/507))
- Support querying external data sources in BigQuery ([#507](https://github.com/dbt-labs/dbt/pull/507))
- Override which schema models are materialized in ([#522](https://github.com/dbt-labs/dbt/pull/522)) ([docs](https://docs.getdbt.com/v0.9/docs/using-custom-schemas))
- Make `{{ ref(...) }}` return the same type of object as `{{ this }} `([#530](https://github.com/dbt-labs/dbt/pull/530))
- Replace schema test CTEs with subqueries to speed them up for Postgres ([#536](https://github.com/dbt-labs/dbt/pull/536)) ([@ronnyli](https://github.com/ronnyli))
- Bump Snowflake dependency, remove pyasn1 ([#570](https://github.com/dbt-labs/dbt/pull/570))
...
- [@ronnyli](https://github.com/ronnyli) ([#536](https://github.com/dbt-labs/dbt/pull/536))
...
- Fix for federated queries on BigQuery with Service Account json credentials ([#547](https://github.com/dbt-labs/dbt/pull/547))
...
- Fix broken integration tests ([#539](https://github.com/dbt-labs/dbt/pull/539))
- Fix for `--non-destructive` on views ([#539](https://github.com/dbt-labs/dbt/pull/539))
- Fix for package models materialized in the wrong schema ([#538](https://github.com/dbt-labs/dbt/pull/538))
- Fix for broken environment variables ([#543](https://github.com/dbt-labs/dbt/pull/543))

### New Contributors

- [@ronnyli](https://github.com/ronnyli)
  - https://github.com/dbt-labs/dbt/pull/536
...
- Parity for `statement` interface on BigQuery ([#526](https://github.com/dbt-labs/dbt/pull/526))
...
- Fix errant warning for `dbt archive` commands ([#476](https://github.com/dbt-labs/dbt/pull/476))
- Show error (instead of backtrace) for failed hook statements ([#478](https://github.com/dbt-labs/dbt/pull/478))
- `dbt init` no longer leaves the repo in an invalid state ([#487](https://github.com/dbt-labs/dbt/pull/487))
- Fix bug which ignored git tag specs for package repos ([#463](https://github.com/dbt-labs/dbt/issues/463))

### Changes

- Support BigQuery as a target ([#437](https://github.com/dbt-labs/dbt/issues/437)) ([#438](https://github.com/dbt-labs/dbt/issues/438))
- Make dbt exit codes significant (0 = success, 1/2 = error) ([#297](https://github.com/dbt-labs/dbt/issues/297))
- Add context function to pull in environment variables ([#450](https://github.com/dbt-labs/dbt/issues/450))
...
- Fix bug for interleaved sort keys on Redshift ([#430](https://github.com/dbt-labs/dbt/pull/430))

### Changes

- Don't try to create schema if it already exists ([#446](https://github.com/dbt-labs/dbt/pull/446))
- Summarize failures for dbt invocations ([#443](https://github.com/dbt-labs/dbt/pull/443))
- Colorized dbt output ([#441](https://github.com/dbt-labs/dbt/pull/441))
- Cancel running queries on ctrl-c ([#444](https://github.com/dbt-labs/dbt/pull/444))
- Better error messages for common failure modes ([#445](https://github.com/dbt-labs/dbt/pull/445))
- Upgrade dependencies ([#431](https://github.com/dbt-labs/dbt/pull/431))
- Improvements to `dbt init` and first time dbt usage experience ([#439](https://github.com/dbt-labs/dbt/pull/439))

### Documentation

- Document full-refresh requirements for incremental models ([#417](https://github.com/dbt-labs/dbt/issues/417))
- Document archival ([#433](https://github.com/dbt-labs/dbt/issues/433))
- Document the two-version variant of `ref` ([#432](https://github.com/dbt-labs/dbt/issues/432))
...
- Fix bug preventing overriding a disabled package model in the current project ([#391](https://github.com/dbt-labs/dbt/pull/391))
- Fix bug which prevented multiple sort keys (provided as an array) on Redshift ([#397](https://github.com/dbt-labs/dbt/pull/397))
- Fix race condition while compiling schema tests in an empty `target` directory ([#398](https://github.com/dbt-labs/dbt/pull/398))

### Changes

- Reintroduce dbt `compile` command ([#407](https://github.com/dbt-labs/dbt/pull/407))
- Compile `on-run-start` and `on-run-end` hooks to a file ([#412](https://github.com/dbt-labs/dbt/pull/412))

### Documentation

- Move docs to readme.io ([#414](https://github.com/dbt-labs/dbt/pull/414))
- Add docs for event tracking opt-out ([#399](https://github.com/dbt-labs/dbt/issues/399))
...
- Fix ephemeral load order bug ([#292](https://github.com/dbt-labs/dbt/pull/292), [#285](https://github.com/dbt-labs/dbt/pull/285))
- Support composite unique key in archivals ([#324](https://github.com/dbt-labs/dbt/pull/324))
- Fix target paths ([#331](https://github.com/dbt-labs/dbt/pull/331), [#329](https://github.com/dbt-labs/dbt/issues/329))
- Ignore commented-out schema tests ([#330](https://github.com/dbt-labs/dbt/pull/330), [#328](https://github.com/dbt-labs/dbt/issues/328))
- Fix run levels ([#343](https://github.com/dbt-labs/dbt/pull/343), [#340](https://github.com/dbt-labs/dbt/issues/340), [#338](https://github.com/dbt-labs/dbt/issues/338))
- Fix concurrency, open a unique transaction per model ([#345](https://github.com/dbt-labs/dbt/pull/345), [#336](https://github.com/dbt-labs/dbt/issues/336))
- Handle concurrent `DROP ... CASCADE`s in Redshift ([#349](https://github.com/dbt-labs/dbt/pull/349))
- Always release connections (use `try .. finally`) ([#354](https://github.com/dbt-labs/dbt/pull/354))

### Changes

- Changed: different syntax for "relationships" schema tests ([#339](https://github.com/dbt-labs/dbt/pull/339))
- Added: `already_exists` context function ([#372](https://github.com/dbt-labs/dbt/pull/372))
- Graph refactor: fix common issues with load order ([#292](https://github.com/dbt-labs/dbt/pull/292))
- Graph refactor: multiple references to an ephemeral models should share a CTE ([#316](https://github.com/dbt-labs/dbt/pull/316))
- Graph refactor: macros in flat graph ([#332](https://github.com/dbt-labs/dbt/pull/332))
- Refactor: factor out jinja interactions ([#309](https://github.com/dbt-labs/dbt/pull/309))
- Speedup: detect cycles at the end of compilation ([#307](https://github.com/dbt-labs/dbt/pull/307))
- Speedup: write graph file with gpickle instead of yaml ([#306](https://github.com/dbt-labs/dbt/pull/306))
- Clone dependencies with `--depth 1` to make them more compact ([#277](https://github.com/dbt-labs/dbt/issues/277), [#342](https://github.com/dbt-labs/dbt/pull/342))
- Rewrite materializations as macros ([#356](https://github.com/dbt-labs/dbt/pull/356))
...
- improved graph selection for `dbt run` and `dbt test` ([more information](http://dbt.readthedocs.io/en/master/guide/usage/#run)) ([#279](https://github.com/dbt-labs/dbt/pull/279))
- profiles.yml now supports Snowflake `role` as an option ([#291](https://github.com/dbt-labs/dbt/pull/291))

#### A new home for dbt

In v0.7.1, dbt was moved from the analyst-collective org to the dbt-labs org ([#300](https://github.com/dbt-labs/dbt/pull/300))
...
- dbt now supports [Snowflake](https://www.snowflake.net/) as a warehouse ([#259](https://github.com/dbt-labs/dbt/pull/259))

#### Bugfixes

- use adapter for sort/dist ([#274](https://github.com/dbt-labs/dbt/pull/274))

#### Deprecations

- run-target and name validations ([#280](https://github.com/dbt-labs/dbt/pull/280))
- dry-run removed ([#281](https://github.com/dbt-labs/dbt/pull/281))

#### Changes

- fixed a typo in the docs related to post-run hooks ([#271](https://github.com/dbt-labs/dbt/pull/271))
- refactored tracking code to refresh invocation id in a multi-run context ([#273](https://github.com/dbt-labs/dbt/pull/273))
- added unit tests for the graph ([#270](https://github.com/dbt-labs/dbt/pull/270))

## dbt 0.6.2 (January 16, 2017)

#### Changes

- condense error output when `--debug` is not set ([#265](https://github.com/dbt-labs/dbt/pull/265))

## dbt 0.6.1 (January 11, 2017)

#### Bugfixes

- respect `config` options in profiles.yml ([#255](https://github.com/dbt-labs/dbt/pull/255))
- use correct `on-run-end` option for post-run hooks ([#261](https://github.com/dbt-labs/dbt/pull/261))

#### Changes

- add `--debug` flag, replace calls to `print()` with a global logger ([#256](https://github.com/dbt-labs/dbt/pull/256))
- add pep8 check to continuous integration tests and bring codebase into compliance ([#257](https://github.com/dbt-labs/dbt/pull/257))
...
For detailed information on how to use Macros, check out the pull request [here](https://github.com/dbt-labs/dbt/pull/245)

### Runtime Materialization Configs

DBT Version 0.6.0 introduces two new ways to control the materialization of models:

#### Non-destructive dbt run [more info](https://github.com/dbt-labs/dbt/issues/137)
...
#### Incremental Model Full Refresh [more info](https://github.com/dbt-labs/dbt/issues/140)
...
### Minor improvements [more info](https://github.com/dbt-labs/dbt/milestone/15?closed=1)

#### Add a `{{ target }}` variable to the dbt runtime [more info](https://github.com/dbt-labs/dbt/issues/149)
...
#### User-specified `profiles.yml` dir [more info](https://github.com/dbt-labs/dbt/issues/213)
...
#### Add timestamp to console output [more info](https://github.com/dbt-labs/dbt/issues/125)

Informative _and_ pretty

#### Run dbt from subdirectory of project root [more info](https://github.com/dbt-labs/dbt/issues/129)
...
#### Pre and post run hooks [more info](https://github.com/dbt-labs/dbt/issues/226)
...
We fixed 10 bugs in this release! See the full list [here](https://github.com/dbt-labs/dbt/milestone/11?closed=1)
...
- dbt-core integration tests
  - running in Continuous Integration environments
    ...
    - linux ([circle](https://circleci.com/gh/dbt-labs/dbt/tree/master))
  - with [code coverage](https://circleci.com/api/v1/project/dbt-labs/dbt/latest/artifacts/0/$CIRCLE_ARTIFACTS/htmlcov/index.html?branch=development)
...
With the dbt 0.5.4 release, dbt now features a robust integration test suite. These integration tests will help mitigate the risk of software regressions, and in so doing, will help us develop dbt more quickly. You can check out the tests [here](https://github.com/dbt-labs/dbt/tree/development/test/integration), and the test results [here (linux/osx)](https://circleci.com/gh/dbt-labs/dbt/tree/master) and [here (windows)](https://ci.appveyor.com/project/DrewBanin/dbt/branch/development).

### The Future

You can check out the DBT roadmap [here](https://github.com/dbt-labs/dbt/milestones). In the next few weeks, we'll be working on [bugfixes](https://github.com/dbt-labs/dbt/milestone/11), [minor features](https://github.com/dbt-labs/dbt/milestone/15), [improved macro support](https://github.com/dbt-labs/dbt/milestone/14), and [expanded control over runtime materialization configs](https://github.com/dbt-labs/dbt/milestone/9).
...
The additions of automated testing and a more comprehensive manual testing process will go a long way to ensuring the future stability of dbt. We're going to get started on these tasks soon, and you can follow our progress here: https://github.com/dbt-labs/dbt/milestone/16 .
...
See https://github.com/dbt-labs/dbt/releases/tag/v0.5.1
...
### 1. Source table archival https://github.com/dbt-labs/dbt/pull/183
...
### 2. Incremental column expansion https://github.com/dbt-labs/dbt/issues/175
...
### 3. First-class Postgres support https://github.com/dbt-labs/dbt/pull/183
...
### 4. Root-level configs https://github.com/dbt-labs/dbt/issues/161
...
### 5. --threads CLI option https://github.com/dbt-labs/dbt/issues/143
...
### 1. new incremental model generation https://github.com/dbt-labs/dbt/issues/138
...
### 2. Arbitrary configuration https://github.com/dbt-labs/dbt/issues/146
...
### 3. specify a dependency branch https://github.com/dbt-labs/dbt/pull/165
...
### 1. --version https://github.com/dbt-labs/dbt/issues/135
...
### 2. pre-and-post-hooks https://github.com/dbt-labs/dbt/pull/147
...
### 4. Windows support https://github.com/dbt-labs/dbt/pull/154
...
### 1. new dbt command structure https://github.com/dbt-labs/dbt/issues/109
...
### 2. Incremental model improvements https://github.com/dbt-labs/dbt/issues/101
...
### 3. Run schema validations concurrently https://github.com/dbt-labs/dbt/issues/100

The `threads` run-target config now applies to schema validations too. Try it with `dbt test`

### 4. Connect to database over ssh https://github.com/dbt-labs/dbt/issues/93
...
### Remove the model-defaults config https://github.com/dbt-labs/dbt/issues/111
...
### 1. Feature: `{{this}}` template variable https://github.com/dbt-labs/dbt/issues/81
...
### 2. Feature: `materialized: incremental` https://github.com/dbt-labs/dbt/pull/90
...
### 3. Feature: `materialized: ephemeral` https://github.com/dbt-labs/dbt/issues/78
...
### 4. Feature: In-model configs https://github.com/dbt-labs/dbt/issues/88
...
### 5. Fix: dbt seed null values https://github.com/dbt-labs/dbt/issues/102
...
#### 1. Parallel model creation https://github.com/dbt-labs/dbt/pull/83
...
For a complete example, check out [a sample profiles.yml file](https://github.com/dbt-labs/dbt/blob/master/sample.profiles.yml)

#### 2. Fail only within a single dependency chain https://github.com/dbt-labs/dbt/issues/63
...
#### 3. Logging https://github.com/dbt-labs/dbt/issues/64, https://github.com/dbt-labs/dbt/issues/65
...
#### 4. Minimize time models are unavailable in the database https://github.com/dbt-labs/dbt/issues/68
...
#### 5. Arbitrarily deep nesting https://github.com/dbt-labs/dbt/issues/50
...
More information is available on the [issue](https://github.com/dbt-labs/dbt/issues/50) and in the [sample dbt_project.yml file](https://github.com/dbt-labs/dbt/blob/master/sample.dbt_project.yml)

#### 6. don't try to create a schema if it already exists https://github.com/dbt-labs/dbt/issues/66
